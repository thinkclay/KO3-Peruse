...
class Model_Missouri_Kansas extends Model_Peruse
{
    ...
    private $raw_dir    = '/raw/missouri/kcpd/';
    private $tmp_dir    = '/tmp';
    private $final_dir  = '/mugs/missouri/kansas/';
    private $errors     = '';
    ...
    public function scrape()
    {
        ...
        foreach ( $offenders as $offender )
        {
            ...
            if ( $key = trim(preg_replace('/\.jpg/i', '', $offender_data[4])) )
            {
                ...
                $offenders_merged[$key]['firstname'] = explode(' ', $name[1]);
                $offenders_merged[$key]['firstname'] = $offenders_merged[$key]['firstname'][0];
